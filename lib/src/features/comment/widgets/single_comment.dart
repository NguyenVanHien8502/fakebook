    ...
    setState(() {
      ...
      if (list[1] > 0) {
        if (list[1] == widget.comment.like &&
            icons[0] != 'lib/src/assets/images/reactions/like.png') {
          icons.add('lib/src/assets/images/reactions/like.png');
        } else if (list[1] == widget.comment.haha &&
            icons[0] != 'lib/src/assets/images/reactions/haha.png') {
          icons.add('lib/src/assets/images/reactions/haha.png');
        } else if (list[1] == widget.comment.love &&
            icons[0] != 'lib/src/assets/images/reactions/love.png') {
          icons.add('lib/src/assets/images/reactions/love.png');
        } else if (list[1] == widget.comment.lovelove &&
            icons[0] != 'lib/src/assets/images/reactions/care.png') {
          icons.add('lib/src/assets/images/reactions/care.png');
        } else if (list[1] == widget.comment.wow &&
            icons[0] != 'lib/src/assets/images/reactions/wow.png') {
          icons.add('lib/src/assets/images/reactions/wow.png');
        } else if (list[1] == widget.comment.sad &&
            icons[0] != 'lib/src/assets/images/reactions/sad.png') {
          icons.add('lib/src/assets/images/reactions/sad.png');
        } else if (list[1] == widget.comment.angry &&
            icons[0] != 'lib/src/assets/images/reactions/angry.png') {
          icons.add('lib/src/assets/images/reactions/angry.png');
        }
      }
      ...
      if (list[2] > 0) {
        if (list[2] == widget.comment.like &&
            !icons.contains('lib/src/assets/images/reactions/like.png')) {
          icons.add('lib/src/assets/images/reactions/like.png');
        } else if (list[2] == widget.comment.haha &&
            !icons.contains('lib/src/assets/images/reactions/haha.png')) {
          icons.add('lib/src/assets/images/reactions/haha.png');
        } else if (list[2] == widget.comment.love &&
            !icons.contains('lib/src/assets/images/reactions/love.png')) {
          icons.add('lib/src/assets/images/reactions/love.png');
        } else if (list[2] == widget.comment.lovelove &&
            !icons.contains('lib/src/assets/images/reactions/care.png')) {
          icons.add('lib/src/assets/images/reactions/care.png');
        } else if (list[2] == widget.comment.wow &&
            !icons.contains('lib/src/assets/images/reactions/wow.png')) {
          icons.add('lib/src/assets/images/reactions/wow.png');
        } else if (list[2] == widget.comment.sad &&
            !icons.contains('lib/src/assets/images/reactions/sad.png')) {
          icons.add('lib/src/assets/images/reactions/sad.png');
        } else if (list[2] == widget.comment.angry &&
            !icons.contains('lib/src/assets/images/reactions/angry.png')) {
          icons.add('lib/src/assets/images/reactions/angry.png');
        }
      }
    });
